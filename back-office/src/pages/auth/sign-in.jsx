  ...
  return (
    <section className="flex gap-4">
      <div className="w-full mt-24 lg:w-3/5">
        ...
        <form className="max-w-screen-lg mx-auto mt-8 mb-2 w-80 lg:w-1/2"  onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col gap-6 mb-1">
            ...
            <Input
              ...
              {...register("email")}
            />
      {errors.email && <p className='absolute mt-2 text-sm text-red-500'>{errors.email.message}</p>}
      {!errors.email && error && <p className='absolute mt-2 text-sm text-red-500'>{error}</p>}
      </div>
           ...
           <Typography variant="small" color="blue-gray" className="mb-2 font-medium">
            ...
            />
      {errors.password && <p className='absolute mt-2 text-sm text-red-500'>{errors.password.message}</p>}
           </div>
      ...
      <div className="hidden w-2/5 h-screen lg:block">
        <img
          // src="/img/pattern.png"
